...
# HILIC variables: 
Area.positive <- Area_HILICPos
Mz.positive   <- Mz_HILICPos
RT.positive   <- RT_HILICPos
SN.positive   <- SN_HILICPos

Area.negative <- Area_HILICNeg
Mz.negative   <- Mz_HILICNeg
RT.negative   <- RT_HILICNeg
SN.negative   <- SN_HILICNeg
