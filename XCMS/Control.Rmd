...
write.csv(addiso_peaks, file = paste0(pretty_folder, "addiso_features.csv"), row.names = FALSE)
knitr::kable(head(addiso_peaks))

# Write out data frame containing all "real" peaks
write.csv(real_peaks, file = paste0(pretty_folder, "addiso_features.csv"), row.names = FALSE)
...
complete_peaks <- read.csv(paste0(pretty_folder, "complete_peaks.csv"))
falkor_stans <- read.csv("falkor_stans.csv")
